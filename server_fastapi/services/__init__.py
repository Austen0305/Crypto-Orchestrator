...
def _lazy_load_ml_imports():
    ...
    try:
        ...
        logger.warning(f"Failed to load ML services: {e}. ML features will be disabled.")
        _ml_imports = {
            'EnhancedMLEngine': None,
            'enhanced_ml_engine': None,
            'TechnicalIndicators': None,
...
def __getattr__(name):
    ...
    if name in ['EnhancedMLEngine', 'enhanced_ml_engine', 'TechnicalIndicators', 'MLPrediction', 'MarketData',
                'EnsembleEngine', 'ensemble_engine', 'EnsemblePrediction',
                'NeuralNetworkEngine', 'neural_network_engine', 'NeuralNetworkConfig']:
