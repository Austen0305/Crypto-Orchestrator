...
class CoinbaseService:
    ...
    def __init__(
        ...
        self.name = (
            "coinbasepro"  # CCXT uses 'coinbasepro' for Coinbase Pro/Advanced Trade
        )
        ...
        if use_mock is not None:
            ...
            self.use_mock = (
                ...
                or os.getenv("USE_MOCK_COINBASE", "false").lower() == "true"
            )
            ...
            if self.use_mock:
                return {
                    ...
                    "last": (
                        50000.0
                        if symbol.startswith("BTC")
                        else 3500.0 if symbol.startswith("ETH") else 1.0
                    ),
                    "bid": 49990.0,
                    "ask": 50010.0,
                    "volume": 1000.0,
    ...
    async def get_fees(self) -> CoinbaseFee:
        ...
        try:
            ...
            return CoinbaseFee(maker=0.005, taker=0.005, tier="basic")  # 0.5%  # 0.5%
        except Exception as error:
