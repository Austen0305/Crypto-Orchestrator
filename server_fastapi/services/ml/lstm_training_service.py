...
class LSTMTrainingService:
    ...
    def __init__(self):
        ...
        if not self.ml_available:
            logger.warning("ML libraries not available. Install tensorflow and scikit-learn for full functionality.")
    ...
    def prepare_data(
        ...
        logger.info(f"Prepared {len(X)} training sequences with {len(feature_cols)} features")
