...
async def audit_order_create(
    user_id: str, order_id: str, details: Dict, ip_address: str
):
...
async def audit_bot_action(
    action: AuditAction, user_id: str, bot_id: str, ip_address: str
):
...
async def audit_security_event(
    action: AuditAction, user_id: str, details: Dict, ip_address: str
):
