...
async def create_setup_intent(
    request: CreateSetupIntentRequest, current_user: dict = Depends(get_current_user)
) -> Dict:
...
async def attach_payment_method(
    request: AttachPaymentMethodRequest, current_user: dict = Depends(get_current_user)
) -> Dict:
