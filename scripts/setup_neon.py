...
def validate_neon_connection_string(connection_string: str) -> Tuple[bool, str, Optional[dict]]:
    ...
    # Check for SSL mode
    if params and 'sslmode=require' not in params:
        return False, "Missing required parameter: ?sslmode=require", None
...
def generate_secrets() -> dict:
    ...
    return {
        ...
        'EXCHANGE_KEY_ENCRYPTION_KEY': secrets.token_hex(16)  # 32 chars
    }
...
# Generated by setup_neon.py on {os.popen('date').read().strip()}
